...
<tag:header/>
<div class="container">
    <form:form method="POST" action="/lms/training/edit" commandName="trainingForm">
        <div class="table add-edit">
            ...
            <div class="grid grid-pad">
                ...
                <div class="col-2-3">
                    ...
                    <form:select id="domain" path="domains" items="${domains}" itemValue="id" itemLabel="name" multiple="true"/>
                </div>
            </div>
...
<tag:footer/>
<script>
    <c:forEach items="${trainingForm.domains}" var="domain">
        document.getElementById('domain').value = ${domain.id};
    </c:forEach>
</script>
</body>
</html>